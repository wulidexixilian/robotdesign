...
"""
import numpy as np
from model.rMath import rotation, h, solveZYX, solveEuler, triangle
from model.rComponent import Body, Joint, Drive
...
class Kinematics():
    ...
    def kukaLocal2local(self, pose_kukaLocal, ref, target="cs"):
        """
...
class Dynamics(Kinematics):
    ...
    def solve_drivetrain(self, q_dot, q_ddot):
        ...
        """
        self.fr_thresholds = np.array([0.0006, 0.0006, 0.0006, 0.0002, 0.0002, 0.0002])
